...
public class Controller implements Initializable {
    ...
    public void createPlayground() {
        ...
        setNamesButton.setOnAction(event -> {
            ...
            rectangleList = createClickableColumns();
    ...
    private boolean gameEnded(int row, int column) {
        ...
        boolean isEnded = checkCombinations(verticalPoints) || checkCombinations(horizontalPoints) || checkCombinations(diagonal1Point) || checkCombinations(diagonal2Point);
        return isEnded;
    }
